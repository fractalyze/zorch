...
class StandardRoundTest(absltest.TestCase):
    ...
    def test_round_poly_degree2_product(self) -> None:
        ...
        msg = _product_round(2)._round_poly(jnp.stack([a, b]))
    ...
    def test_round_poly_is_fusion_ready(self) -> None:
        ...
        assert_fusion_ready(_product_round(2)._round_poly, jnp.stack([a, b]), reduces=1)
...
class CompressedProductRoundTest(absltest.TestCase):
    ...
    def test_round_poly_is_fusion_ready(self) -> None:
        ...
        assert_fusion_ready(
            prover.CompressedProductRound()._round_poly, jnp.stack([a, b]), reduces=1
        )

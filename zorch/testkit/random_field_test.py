...
class RandFieldTest(absltest.TestCase):
    def test_shape_dtype_deterministic(self) -> None:
        a = rand_field(0, (8,), zk_dtypes.koalabear)
        b = rand_field(0, (8,), zk_dtypes.koalabear)
        self.assertEqual(a.shape, (8,))
        self.assertEqual(a.dtype, zk_dtypes.koalabear)
        self.assertTrue(bool(jnp.all(a == b)))  # same seed -> same values

    def test_different_seed_differs(self) -> None:
        a = rand_field(0, (16,), zk_dtypes.koalabear)
        b = rand_field(1, (16,), zk_dtypes.koalabear)

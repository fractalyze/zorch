...
| Hashing | One `Permutation` seam; a consumer ships only a params object (width, field, constants) — sponge and compression code never fork. | [hash](https://github.com/fractalyze/zorch/blob/main/docs/blocks/hash.md) |
